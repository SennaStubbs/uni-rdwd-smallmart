...
<nav>
    ...
    <!-- Burger menu -->
    <a class="burger-button material-symbols-outlined" data-dropdown-id="nav-burger-menu" onclick="ToggleDropdown(this)">
        menu
    </a>
    <div class="burger-menu hidden" id="nav-burger-menu">
        <div class="container">
            <div class="title">
                <h1>MENU</h1>
                <button class="material-symbols-outlined" data-dropdown-id="nav-burger-menu" onclick="ToggleDropdown(this)">close</button>
            </div>
            <div class="burger-contents">
                ...
                <!-- Categories dropdown -->
                <a class="dropdown" data-dropdown-id="mobile-categories-dropdown" onclick="ToggleDropdown(this)">
                    <span>CATALOGUE</span>
                ...
                <div class="divider"></div>
                <!-- More dropdown -->
                <a class="dropdown" data-dropdown-id="mobile-more-dropdown" onclick="ToggleDropdown(this, true)">
                    <span>MORE</span>
                    <span class="material-symbols-outlined">keyboard_arrow_down</span>
                </a>
                <div class="divider"></div>
    ...
    <!-- Wishlist -->
    <a <?php if (isset($_SESSION['user_id'])) { echo 'href="/smallmart/website/wishlist"'; } else { echo 'href="/smallmart/website/log-in?redirect=wishlist"'; } ?> style="font-weight: normal" class="button wishlist">
        <span class="material-symbols-outlined">favorite</span>
        <span>WISHLIST</span>
    </a>
    <!-- Log in / account -->
    ...
    ?>
    <a href="/smallmart/website/user" class="button account" title="Logged in as: <?php echo $row['user_display_name'] ?>">
        <span class="material-symbols-outlined filled">account_circle</span>
        <span>ACCOUNT</span>
    </a>
    <?php } else { ?>
    <a href="/smallmart/website/log-in" class="button account">
